...
<div id="header">
    ...
    <h2 style="color: white;position: absolute">
        <a href="dashboard" style="color:white; margin-left: 30px; margin-top: 40px">SMS</a>
    </h2>
</div>
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
        <li class="dropdown" id="profile-messages">
            <a title="" href="dashboard.php" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i
...
<div id="sidebar">
    <ul>
        ...
        <li class="">
        <a href="manage_products.php"><i class="icon icon-user"></i><span>Manage Products</span></a>
        </li>
        <li class="">
        <a href="manage_stock.php"><i class="icon icon-user"></i><span>Manage Stock</span></a>
        </li>
